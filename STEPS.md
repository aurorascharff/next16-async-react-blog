...
- And what about expected errors? We should probably toast here to let them know if something went wrong with the archiving. Let's stop them from archiving seed posts with a toast. Ask your designer what these toasts should look like to fit the app design, and what the text should be per error.
